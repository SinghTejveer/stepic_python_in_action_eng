...
(1 – up, 2 – down, 3 – left, 4 – right, 0 – stay) and outputs the text
«move up» (or «move down», or «move left», or «move right», or «do not move»
...
Note: the output text should exactly match the sample! Including letters case
